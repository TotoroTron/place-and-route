...
create_clock -add -name sys_clk_pin -period 100.00 -waveform {0 4} [get_ports { i_clk }];
...
set_property -dict { PACKAGE_PIN D20    IOSTANDARD LVCMOS33 } [get_ports { i_din_b }]; #IO_L4N_T0_35 Sch=BTN1
set_property -dict { PACKAGE_PIN L20    IOSTANDARD LVCMOS33 } [get_ports { i_valid }]; #IO_L9N_T1_DQS_AD3N_35 Sch=BTN2
set_property -dict { PACKAGE_PIN L19    IOSTANDARD LVCMOS33 } [get_ports { i_ready }]; #IO_L9P_T1_DQS_AD3P_35 Sch=BTN3
