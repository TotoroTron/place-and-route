...
## LEDs
set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { o_led }]; #IO_L6N_T0_VREF_34 Sch=LED0
...
## Buttons
set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { i_btn_0 }]; #IO_L4P_T0_35 Sch=BTN0
set_property -dict { PACKAGE_PIN D20    IOSTANDARD LVCMOS33 } [get_ports { i_btn_1 }]; #IO_L4N_T0_35 Sch=BTN1
...
set_property IO_BUFFER_TYPE OBUF [ o_led ]
set_property IO_BUFFER_TYPE IBUF [ i_btn_0 i_btn_1 ]
