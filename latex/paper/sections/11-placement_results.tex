...
\begin{multicols}{2}
    ...
    Shown in figure \ref{fig:VaryCoolingSchedules} are the cost histories for various cooling schedules, grouped three different initial temperatures \texttt{(5000, 10000, and 15000)}. 
    For each initial temperature group, we test four different cooling rates \texttt{(0.92, 0.94, 0.96, and 0.98)}, with the darkness of each curve corresponding with a slower cooling rate.
\end{multicols}
