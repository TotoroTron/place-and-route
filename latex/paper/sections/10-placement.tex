...
The process of spreading objects somewhat resembles primitive fluid dynamics simulators or thermal diffusion simulators, where packets of energy are spread around an object until each voxel or pixel meets a maximum threshold of energy. 
