...
\section{Xilinx 7-Series Architecture}
    ...
    The 7-Series architecture first released in 2010 and was superceded in 2013 by the Ultrascale architecture which made several improvements over the 7-Series. 
    ...
    These SLICE Sites facilitate the core programmable logic of the FPGA. 
