...
\section{Placement Implementation}
    ...
    \subsection{PrePacking}
        ...
        \begin{figure}
            \centering
            \includegraphics[width=4.0cm]{figures/edif_net.png}
            \includegraphics[width=4.0cm]{figures/intrasite_route.png}
            \includegraphics[width=8.0cm]{figures/intersite_route.png}
            \caption{
