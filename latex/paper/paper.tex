...
\section{Xilinx 7-Series Architecture}
    ...
    \textbf{DSP Cascades} \quad 
        ...
        They are connected by three 48-bit signal busses: ACOUT to ACIN, BCOUT to BCIN, PCOUT to PCIN.
        ...
        {
            \centering
            \includegraphics[valign=c, width=3.0cm]{figures/dsp_cascade_placement.png}
            \includegraphics[valign=c, width=4.0cm]{figures/dsp_cascade_routed.png}
            \captionof{figure}{
