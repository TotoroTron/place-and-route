...
\section{What is a Netlist?}
    ...
    In a synthesized Netlist, the leaf cells (lowest-level cells) are necessarily primitive cells from the vendor primitives library such as \texttt{LUT6}, \texttt{FDRE}, \texttt{CARRY4}, \texttt{DSP48E1}, etc.. 
...
\section{Simulated Annealing}
    ...
    \subsection{Prepacking}
        ...
        Likewise, \textttt{DSP48E1} cascades must necessarily be placed vertically and consecutively across a column of DSP48E1 Sites in ascending order. 
